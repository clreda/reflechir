...
__Déf__ : Soit $n \in \mathbb{N} \setminus \{0,1\}$. Soient $a_1,\dots,a_n \in \mathbb{N}$. Le plus grand commun diviseur de $a_1,\dots,a_n$, noté pgcd$(a_1,\dots,a_n)$, est l'entier $d \in \mathbb{N}$ qui vérifie $d \ | \ a_1$, \dots, $d \ | \ a_n$ et si $c \ | \ a_1$, \dots, $c \ | \ a_n$ alors $c \ | \ d$.  
...
__Déf__ : Soit $n \in \mathbb{N} \setminus \{0,1\}$. Soient $a_1,\dots,a_n \in \mathbb{N}$. Le plus petit commun multiple de $a_1,\dots,a_n$, noté ppcm$(a_1,\dots,a_n)$, est l'entier $m \in \mathbb{N}$ qui vérifie $a_1 \ | \ m$, \dots, $a_n \ | \ m$ et si $a_1 \ | \ c$, \dots, $a_n \ | \ c$ alors $m \ | \ c$.  
...
\noindent Si $(x,y,z)$ est un triplet pythagoricien on a : $x^2 + y^2 = z^2$ d'où $c^2 \times (x^2 + y^2) = c^2 \times z^2$ d'où $c^2 \times x^2 + c^2 \times y^2 = c^2 \times z^2$ d'où $(cx)^2 + (cy)^2 = (cz)^2$.\\
...
\noindent $m = 4q + r$ avec $r \in \{0,1,2,3\}$. $m^2 = (4q + r)(4q + r) = 4(4q^2 + 2qr) + r^2$, donc si $r = 0$ alors le reste de $m^2$ est $0$ (car $0^2 = 0$), si $r = 1$ alors le reste de $m^2$ est $1$ (car $1^2 = 1$), si $r = 2$ alors $m^2 = 4(4q^2 + 4q + 1)$ (car $2^2 = 4$) donc le reste de $m^2$ est $0$, si $r = 3$ alors $m^2 = 4(4q^2 + 6q + 2) + 1$ (car $3^2 = 9 = 4 \times 2 + 1$) donc le reste de $m^2$ est $1$.\\
...
\noindent Si $4$ divise $x^2$ et $y^2$ alors $4$ divise $x^2 + y^2 = z^2$, ce qui contredit pgcd$(x^2,y^2,z^2) = 1$ (qui découle de pgcd$(x,y,z) = 1$). Ainsi, $4$ ne divise pas à la fois $x^2$ et $y^2$ (n'hésitez pas à réviser le raisonnement par l'absurde (cf. l'article 3)).\\
